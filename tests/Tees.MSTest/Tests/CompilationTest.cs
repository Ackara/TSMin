...
namespace Acklann.Tees.Tests
{
    ...
    public class CompilationTest
    {
        ...
        public void Can_compile_ts_file(string label, int expectedFiles, CompilerOptions options)
        {
            // Arrange
            ...
            // Act
            var result = TypescriptCompiler.Compile(Sample.GetBasicTS().FullName, options);
        ...
        public void Can_detect_ts_errors(string documentPath, int errorLine)
        {
            ...
            // Act
            var result = TypescriptCompiler.Compile(documentPath, options);
        ...
        public void Can_find_ts_files_within_folder()
        {
            ...
            // Act
            var result = TypescriptCompiler.FindFiles(folder);
